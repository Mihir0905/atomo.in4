...
const staticPages = [
  ...
  },
  {
    ...
    description: "Case studies, blogs and press resources from Atomo Innovation.",
    hero: {
      eyebrow: "Resources",
      headline: "Resources.",
      description: "Case studies, blogs and press materials from Atomo Innovation.",
      breadcrumbs: [{ label: "Home", href: "/" }, { label: "Resources" }],
    },
    sections: [{ type: "content", blocks: [
      { type: "link-grid", links: [
        { href: "/resources/case-studies", title: "Case Studies", description: "Real-world edge AI deployments and outcomes." },
        { href: "/resources/blogs", title: "Blogs", description: "Articles and perspectives on edge AI infrastructure." },
